...
//       console.log("pool deletes")
//     }else{
//       deleteTask(selected[0]).then((res) => {
//         if (res) {
//           console.log(res)
//           openSnackbar({
//             state: true,
...
//     navigate(`/task/update/${selected[0]}`);
//     // setAnchorEl(null);
//   };
...
// export const ShowTasksView = ({ rows }) => {
//   console.log("redder ShowTasksView")
...
//                     // sx={{ cursor: "pointer" }}
//                     sx={
//                       row.state === "completed" ? { background: "#e5eefa" } : {}
//                     }
//                   >
//                     <TableCell padding="checkbox">
//                       <Checkbox
...
//                       )}
//                     </TableCell>
//                     {/* <TableCell align="right"><OptionsRowTable id={row.id} /></TableCell> */}
//                   </TableRow>
//                 );
//               })}
//               {emptyRows > 0 && (
